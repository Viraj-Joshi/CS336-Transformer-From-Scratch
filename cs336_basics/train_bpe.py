...
def parallel_pretokenize(input_path,special_tokens):
...
def train_bpe(
    ...
    if file_size < 1_000_000:
        counts = naive_pretokenize(input_path)
    else:
        counts = parallel_pretokenize(input_path,special_tokens)
